document.addEventListener('DOMContentLoaded', () => {
  ...
  // NOTE: This filters out orders=0 days. If you want 1–31 rows even when orders=0,
  // change `d.orders > 0` to `d.orders >= 0` or remove it.
    ...
    if (currentView === 'calendar') {
      ...
      if (monthData.length === 0) {
        ...
        document.getElementById('dataTable').innerHTML =
          '<tr><td colspan="6" style="text-align: center;">No data available for this month</td></tr>';
      ...
      updateTable(monthData); // includes padTableToFill() now
    }
  }
...
`.trim();
  ...
  // ==========================================================
  // PAD TABLE SO IT "FILLS" THE VISIBLE TABLE AREA
  // ==========================================================
  ...
  function updateTable(monthData) {
    ...
    // NEW: pad with blank rows so the table panel looks "full"
    padTableToFill();
  }
  ...
  // Keep padding correct when the screen resizes (and reflow charts)
